...
export const SocialMediaIdentity: React.FC = () => {
  ...
  // Clean Render Loop (Webcam Stream Only)
  const renderLoop = useCallback(() => {
    ...
    if (isCameraActive && video && video.readyState >= 2) {
      // Draw Mirrored Live Webcam Feed
      ctx.save();
      ctx.translate(w, 0);
      ctx.scale(-1, 1);
      ...
      ctx.fillText("CLICK START WEBCAM TO OPEN CAMERA", w / 2, h / 2);
    }
  ...
  return (
    <div className={styles.appContainer} style={{ background: "#0a0a0f", minHeight: "100vh" }}>
      ...
      <div className={styles.sidebar}>
        ...
        <div className={styles.brandSubtitle}>Webcam Feed</div>
        ...
        >
          <span style={{ color: "rgba(255, 255, 255, 0.7)" }}>Camera Status</span>
          <span style={{ color: isCameraActive ? "#00ff22" : "rgba(255, 255, 255, 0.4)", fontWeight: 700 }}>
      ...
      <div className={styles.canvasViewport} ref={containerRef}>
        ...
        <div className={styles.canvasFooter}>
          Webcam Feed • Created by Victor Chen
        </div>
      </div>
    </div>
  );
